def pytest_addoption(parser):
    ...
    parser.addoption('--user', action='store', dest='username', type=str, default='test-nko', help='Username')
    parser.addoption('--password', action='store', dest='password', type=str, default='testNko1', help='Password')
